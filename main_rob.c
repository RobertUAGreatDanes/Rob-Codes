...
char functDisplayAllPlayerView(char **GameBoard, char *state, char *letter, int *num)
{
	*state;
	*letter;
	*num;
	...
	printf("%c ", *letter);
	printf("%d\n", *num);
	char Gameboard[10][10] = {'\0'};

		if(GameBoard[row][*num] == 'x')
		{
		Gameboard[row][*num] = 'x';
		}else if(GameBoard[row][*num] == 'A')
		{
		Gameboard[row][*num] = 'A'; 
		}else if (GameBoard[row][*num] == 'B')
		{
		Gameboard[row][*num] = 'B';
		}else if (GameBoard[row][*num] == 'C')
		{
		Gameboard[row][*num] = 'C';
		}else if (GameBoard[row][*num] == 'D')
		{
		Gameboard[row][*num] = 'D';
		}else if (GameBoard[row][*num] == 'E')
		{
		Gameboard[row][*num] = 'E';
		}
	...
	{
		if(GameBoard[row][*num] == '\0')
		{
		  printf("[?]");
	    }
		else if((GameBoard[row][*num] != '\0'))
		{ 
		 printf("[%c]", Gameboard[j][i]);
	    }
			//Place hit or miss on board
...
do{	
	   printf("\n");
    functDisplayAllPlayerView(GameBoard, state, &character, &integer);
	   printf("\n");
